...
def get_test_input():
    img = cv2.imread("/Users/dariavolkova/Desktop/lab_future/image_check/image1.jpeg")
...
class Darknet(nn.Module):
    ...
    def forward(self, x, CUDA):
        ...
        # Route and shortcut layers need output maps from previous layers,
        ...
        for i,module in enumerate(modules):
            ...
            if module_type == "convolutional" or module_type == "upsample":
                ...
                x = x.data  # Get row data, not torch object
                x = predict_transform(x, inp_dim, anchors, num_classes, CUDA)

                # Once output's been transformed, we can concatenate the detection
                # maps at 3 different scales into one big tensor.
